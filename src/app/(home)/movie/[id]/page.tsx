  ...
  return (
    <div className="bg-gray-900 min-h-screen w-full text-white">
      <div className="max-w-6xl mx-auto px-6 py-10">
        <div className="flex flex-col md:flex-row gap-10 bg-white text-black shadow-2xl rounded-xl p-6" >
          ...
          <div className="md:w-1/2 space-y-4">
            <h1 className="text-4xl font-bold text-gray-800">{res.Title}</h1>
            <p className="text-sm text-gray-600">{res.Plot}</p>
            ...
            <div className="mt-6 bg-red-500 text-white px-5 py-2 w-[100px] rounded hover:bg-red-600 transition">
              ❤️ <AddToFav item={res}/>
            </div>
